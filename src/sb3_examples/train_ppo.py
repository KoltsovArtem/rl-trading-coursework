...
class StockEnv(gym.Env):
    # Разбиение почти идентично A2C, можно вынести в общий модуль, но пока повторим
...
if __name__ == "__main__":
    ...
    model.save(os.path.join(results_dir, "ppo_aapl"))
    ...
    print("Final net worth (PPO):", env.net_worth)
